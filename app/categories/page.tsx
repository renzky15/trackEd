    ...
    <div className="py-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
        {categories.map((category) => (
          <Link
            key={category.name}
            href={`/feedback/new?category=${encodeURIComponent(category.name)}`}
            className="card bg-base-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-base-300"
          >
